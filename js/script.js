(function ($) {
  $(document).ready(function () {
    ...
    function send_form (type) {
      ...
      var dataString = '&entry.979284007=' + name + '&entry.2048316128=' + email + '&entry.981485447=' + guest + '&entry.1630483957=' + attending;
      var form = $(this);
      ...
      $.ajax({
        type: "POST",
        url: "https://docs.google.com/forms/d/e/1FAIpQLSdznQhaSdxDvP93328Eae0mTU29vJL8pecNVSL49SDdEuAqLg/viewform?usp=sf_link",
        data: dataString,
        complete:sent
      });
    }
